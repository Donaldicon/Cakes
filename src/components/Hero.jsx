  ...
  return (
    ...
    <div className='bg-[#d37fcb] mt-1 pb-40 lg:hidden'>
       <div className='relative'>
          <img src="../src/assets/images/Blob Shape.svg" alt="" className='w-3/5'/>
    ...
    <div className='relative sm:hidden lg:block small:hidden'>
      <div className='flex flex-row items-center justify-center bg-purple-500 '>
        ...
        <div className=''>
          <img src="../src/assets/background/semi-circle.png" className='' alt="" />
        </div>
    ...
    <div className='absolute top-0 left-1/2 transform -translate-x-1/2'>
      <img src="../src/assets/background/pattern.png" className='h-[180px] w-[300px] desktop:h-[220px]' alt="" />
    </div>
    <div className='absolute bottom-0 right-0 '>
      <img src="../src/assets/background/pattern.png" className='h-[200px] w-[300px]' alt="" />
    </div>
    <div className='absolute bottom-0 left-[100px]'>
      <img src="../src/assets/background/rose.png" 
      className='w-[800px] ' alt="" />
    </div>

    <div className='flex absolute right-[50px] top-1/4 large:top-[180px] large:right-[20px]'>
        <img src="../src/assets/images/white-cake.png" className='desktop:w-[250px] lgr:w-[200px] large:w-[300px] mr-4' alt="" />
      <div className='flex flex-col'>
        <img src="../src/assets/images/31-fab.png" className='mb-4 desktop:w-[250px] lgr:w-[200px] large:w-[300px]' alt="" />
        <img src="../src/assets/images/red-velvet.png" className='desktop:w-[250px] lgr:w-[200px] large:w-[300px]' alt="" />
      </div>
    </div>
